...
#define SEEK_FREQ   35
#define CENTER_FREQ ((float)(2*PI*CENTER_FREQUENCY/SAMPLE_RATE))
#define HI_FREQ     ((float)(2*PI*(CENTER_FREQUENCY+SEEK_FREQ)/SAMPLE_RATE))
#define LO_FREQ     ((float)(2*PI*(CENTER_FREQUENCY-SEEK_FREQ)/SAMPLE_RATE))
